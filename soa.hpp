...
private:
	map<K, V> book;
	vector<ServiceListener<V>*> listener;
public:

  // Get data on our service given a key
	virtual V& GetData(K key) { return book[key]; };
  ...
  // for data to the Service.
	virtual void AddListener(ServiceListener<V> *_listener) {};

  // Get all listeners on the Service.
	virtual const vector< ServiceListener<V>* >& GetListeners() const { return listener; };
